...
const WomensWear = () => {
  ...
  let products = getAllProduct.filter(ele => ele.gender === 'women');
  ...
  let prices = ['599-699', '699-799', '799-1199', '1199 - 1999', '1999 - 2499'];
  let categories = ['shirts', 't-shirts', 'trousers', 'jeans', 'jackets', 'coats'];
  let color = ['black','white', 'gray','blue', 'green', 'peach', 'beige','brown'];
  ...
  const filteredProducts = products.filter((product) => {
      ...
      return((categoryFilters.length === 0 || categoryFilters.includes(product.category.toLowerCase())) &&
  ...
  return (
    ...
    <Layout>
        {/* main  */}
        <div onClick={()=> closeOptionBox()} className="womensWearPageLayout overflow-x-hidden px-3 md:px-10 text-gray-900 font-serif flex justify-between">
             ...
             <div className="flex flex-col gap-3 p-5  mx-auto w-full ">
                  ...
                  <div id='productContainer_grid_View' className="productContainer_grid_View_3_cols  max-w-full grid grid-cols-3 gap-2 md:gap-5">
